				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<!-- Data Page -->
							<br>
							<h3>การกำหนดสีตัวอักษร</h3>
							<h4>รูปแบบตัวอักษร</h4>
							<b>&nbsp;&nbsp;&nbsp;&nbsp;&lt;font color="..(สี).."&gt;....&lt;/font&gt;</b>
							<br>
							<p>โดยการกำหนดชื่อสีสามารถกำหนดได้ 2 แบบคือ ชื่อสี และรหัสเลขฐาน 16 ในระบบสี RGB</p>
							<br>
							<br>
							...
							<p>
								&lt;font color="#FF0000"&gt;สวัสดี&lt;/font&gt;
							</p>
							<p>
								&lt;font color="red"&gt;สวัสดี&lt;/font&gt;
							</p>
							<br>
